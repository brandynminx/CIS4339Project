...
app.post('/api/note/create', (req, res) => {
  const note = new Note({costs: req.body.costs, location: req.body.location, body: req.body.body, tourDesc: req.body.tourDesc, title: req.body.title, email: req.body.email});
  note.save( (err) => {
